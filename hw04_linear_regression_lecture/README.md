...
1. Выберите датасет
Для выполнения задания вы можете использовать подготовленный датасет по ссылке ниже или выбрать свой собственный датасет для задачи
регрессии (предсказание непрерывной числовой величины).
...
Сравнение скорости: если вы учили несколько разных моделей или использовали подбор гиперпараметров (например, GridSearchCV для
коэффициента регуляризации alpha ), сравните, какая модель обучалась быстрее и почему.
